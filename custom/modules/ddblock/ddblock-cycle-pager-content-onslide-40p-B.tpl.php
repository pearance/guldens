...
/**
 * Dynamic display block module template: onslide-40p-B - pager template
 ...
 */
$number_of_items = 10;        // total number of items to show  
$number_of_items_per_row=10;  // number of items to show in a row
?>

<!-- custom pager images --> 
<div id="ddblock-custom-pager-<?php print $delta ?>" class="<?php print $pager . ' ' . $pager . '-' . $pager_position ?> clear-block border">
