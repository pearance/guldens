...
/**
 * Dynamic display block module template: onslide-40p-B - content template
...
drupal_add_css($directory .'/custom/modules/ddblock/'.$custom_template. '/ddblock-cycle-'.$custom_template. '-'.$slideshow_width.'.css', 'template', 'all', FALSE);
?>
      ...
      <?php foreach ($slider_items as $slider_item): ?>
       <div class="slide clear-block border">
        <div class="slide-inner clear-block border">
         ...
         <div class="slide-text slide-text-<?php print $slide_direction ?> slide-text-<?php print $pager_position . '-' . $slide_text_position?> clear-block border">
         ...
         <div class="slide-read-more slide-read-more-<?php print $pager_position . '-' . $slide_text_position?> clear-block border">
